...
def playGame(train_indicator=1):    #1 means Train, 0 means simply Run
    ...
    #save Reward file
    with open("q_gradient_theltha.txt", 'w') as f1:
        with open("AverageQ_Rofbatch.txt", 'w') as fx:
                ...
                for i in range(episode_count):
                    ...
                    for j in range(max_steps):
                        ...
                        if (train_indicator):
                            ...
                            q_gradient_theltha=actor.final_grads(states, grads)
                        ...
                        if np.mod(j, 50):
                            #fx.write("AverageQofbatch=" + str(ave_q_values_of_batch) + " " + "AverageRofBatch=" + str(ave_reward_of_batch) + "\n")
                            f1.write("q_gradient_theltha=" + str(q_gradient_theltha) + "\n")
